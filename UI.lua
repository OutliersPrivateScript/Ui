...
local settings = {
    folder_name = "TonkaHack"; -- stupid shit
    default_accent = Color3.fromRGB(61, 100, 227); -- also stupid shit
};

local drawing = loadstring(game:HttpGet("https://gist.githubusercontent.com/optixxxlol/043d5c6024b9307e6fa39e090df4f93e/raw/457097fcf289cff78073046e924ac19c928e9d66/extension.lua"))();
...
local themeobjects = {}
local library = {theme = table.clone(themes.Default),currentcolor = nil, folder = "TonkaHack", flags = {}, open = true, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}, notifications = {}};
